...
/*! \enum enum_area
    ...
    An enum where land is set to have a vlue of 1 and water has a value of zero.
*/
...
/*! \fn struct_cell dynamic_alloc_map(int x,int y)
    \brief function
    \param dimensions of x
    \param dimensions of y
*/
